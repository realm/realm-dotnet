...
// ReSharper disable once UnusedParameter.Local
        ...
        private static void Main()
        {
            using (var tbl = new Table())
            {
                ...
                tbl[3].SetRow(198, "TightDB", 12.345);
                    //alternative syntax, specifying row as an index into the table                
                ...
                tbl.SetMixedString("myMixed", 0, "Changed Long value to String");
                    //alternative syntax,specifying the column by name
                tbl.SetMixed(2, 0, "Changed long value to String");
                    //untyped, mixed will adopt whatever Tightdb type matches best with the data in the last parameter, in this case DataType.String
            ...
            tbl3.Add("recordwithsubtable", sub);
            tbl3.Add("recordwithanemptysubtable", null);
            Assert(2 == tbl3.GetSubTable(1, 0).Size);

            //add some rows to the empty subtable in the second row
            using (var subTbl1 = tbl3.GetSubTable("subtable", 1)) //or tbl3.GetSubTable(1,1);{
            {
