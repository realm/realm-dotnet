...
namespace RealmNet.Interop
{
    ...
    public class SharedGroup : Handled
    {
        ...
        //        public SharedGroup()
        //       {
        //          UnsafeNativeMethods.new_shared_group_unattached(this); //calls sethandle itself
        //     }
        ...
        {
            UnsafeNativeMethods.shared_group_open(this,fileName,noCreate,durabilityLevel);
        }
        */
        ...
        {
            get { return UnsafeNativeMethods.shared_group_is_attached(this); }
        }
        */
