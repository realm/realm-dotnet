    ...
    */
    ...
    public class Spec : Handled
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return UnsafeNativeMethods.spec_equals_spec(spec.OwnerRootTable, OwnerRootTable);
        }
        ...
        */
        ...
        {
            get { return UnsafeNativeMethods.spec_get_column_count(this); }
        }
        ...
        {
            return UnsafeNativeMethods.spec_get_column_type(this, columnIndex);
        }
        ...
        {
            return UnsafeNativeMethods.spec_get_column_name(this, columnIndex);
        }
    }
}
