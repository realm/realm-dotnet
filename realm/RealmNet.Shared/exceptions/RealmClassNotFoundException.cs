 ...
 * Realm is being created/opened. A RealmClassNotFoundException will be thrown if this
 * problem exists which means that encryption cannot be used on this device.
 */
public class RealmClassNotFoundException :  RealmException {
        public RealmClassNotFoundException(String message) : base(message) {
