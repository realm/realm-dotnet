 ...
 * Realm is being created/opened. A RealmIndexOutOfBoundsException will be thrown if this
 * problem exists which means that encryption cannot be used on this device.
 */
public class RealmIndexOutOfBoundsException :  RealmException {
        public RealmIndexOutOfBoundsException(String message) : base(message) {
