 ...
 * Realm is being created/opened. A RealmIllegalArgumentException will be thrown if this
 * problem exists which means that encryption cannot be used on this device.
 */
public class RealmIllegalArgumentException :  RealmException {
        public RealmIllegalArgumentException(String message) : base(message) {
