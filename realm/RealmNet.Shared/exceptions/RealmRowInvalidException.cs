 ...
 * Realm is being created/opened. A RealmRowInvalidException will be thrown if this
 * problem exists which means that encryption cannot be used on this device.
 */
public class RealmRowInvalidException :  RealmException {
        public RealmRowInvalidException(String message) : base(message) {
