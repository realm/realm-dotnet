 ...
 * Realm is being created/opened. A RealmTableInvalidException will be thrown if this
 * problem exists which means that encryption cannot be used on this device.
 */
public class RealmTableInvalidException :  RealmException {
        public RealmTableInvalidException(String message) : base(message) {
