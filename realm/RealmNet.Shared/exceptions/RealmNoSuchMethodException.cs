 ...
 * Realm is being created/opened. A RealmNoSuchMethodException will be thrown if this
 * problem exists which means that encryption cannot be used on this device.
 */
public class RealmNoSuchMethodException :  RealmException {
        public RealmNoSuchMethodException(String message) : base(message) {
