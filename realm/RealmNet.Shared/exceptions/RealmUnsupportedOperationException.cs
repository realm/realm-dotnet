 ...
 * Realm is being created/opened. A RealmUnsupportedOperationException will be thrown if this
 * problem exists which means that encryption cannot be used on this device.
 */
public class RealmUnsupportedOperationException :  RealmException {
        public RealmUnsupportedOperationException(String message) : base(message) {
