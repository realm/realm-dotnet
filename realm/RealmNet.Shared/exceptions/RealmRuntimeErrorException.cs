 ...
 * Realm is being created/opened. A RealmRuntimeErrorException will be thrown if this
 * problem exists which means that encryption cannot be used on this device.
 */
public class RealmRuntimeErrorException :  RealmException {
        public RealmRuntimeErrorException(String message) : base(message) {
