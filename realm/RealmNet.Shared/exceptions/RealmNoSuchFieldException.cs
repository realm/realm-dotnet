 ...
 * Realm is being created/opened. A RealmNoSuchFieldException will be thrown if this
 * problem exists which means that encryption cannot be used on this device.
 */
public class RealmNoSuchFieldException :  RealmException {
        public RealmNoSuchFieldException(String message) : base(message) {
