...
const core = __importStar(__nccwpck_require__(679));
// this will need to change when the code will have its own repo
const build_cache_executor = __importStar(__nccwpck_require__(647));
const utils = __importStar(__nccwpck_require__(615));
const input = __importStar(__nccwpck_require__(796));
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const buildResult = yield build_cache_executor.actionCore(paths, cmds, utils.tryGetHash, core);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const command_1 = __nccwpck_require__(728);
...
module.exports = eval("require")("@realm/build_cache_executor/lib/build_cache_executor");
...
module.exports = eval("require")("@realm/build_cache_executor/lib/utils/common");
...
module.exports = eval("require")("@realm/build_cache_executor/lib/utils/input_parsing");
...
/******/ 	return __nccwpck_require__(481);
/******/ })()
;