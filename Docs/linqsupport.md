...
`Contains`, `StartsWith`, and `EndsWith`, and `Equals`. By default, Realm will perform a case-sensitive comparison, but you can provide `StringComparison.OrdinalIgnoreCase` argument to overwrite that.
