...
### Enhancements
* Improved calculation of `SyncProgress.ProgressEstimate`, a double value between 0.0 and 1.0 that expresses the percentage estimate of the current progress. (Issue [#3580](https://github.com/realm/realm-dotnet/issues/3580]))
