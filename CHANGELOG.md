...
- Realm.DataBinding is now a .NET Standard 2.0 library. This adds support for implicit write transactions when using Xamarin.Forms databinding in UWP apps targeting the Windows 10 Fall Creators Update SDK. 
