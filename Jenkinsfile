  ...
  parallel(
    'iOS': {
      ...
      nodeWithCleanup('xamarin-mac') {
        ...
        stash includes: "Realm/Realm/bin/iPhoneSimulator/${configuration}/netstandard1.4/Realm.*", name: 'nuget-database'
  ...
  parallel(
    'iOS': {
      ...
      nodeWithCleanup('xamarin-mac') {
        ...
        stash includes: "Realm/Realm.Sync/bin/iPhoneSimulator/${configuration}/netstandard1.4/Realm.Sync.*", name: 'nuget-sync'
