...
namespace SourceGeneratorPlayground
{
    public partial class OuterClass
    {
        ...
        private partial class NestedClass : IRealmObject, INotifyPropertyChanged, IReflectableType
        {
            ...
            static NestedClass()
            {
                Realms.Serialization.RealmObjectSerializer.Register(new NestedClassSerializer());
            }
            ...
            [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
            private class NestedClassManagedAccessor : Realms.ManagedAccessor, INestedClassAccessor
            {
                public int Id
                {
                    get => (int)GetValue("Id");
            ...
            [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
            private class NestedClassUnmanagedAccessor : Realms.UnmanagedAccessor, INestedClassAccessor
            {
            ...
            private class NestedClassSerializer : Realms.Serialization.RealmObjectSerializerBase<NestedClass>
            {
                ...
                protected override NestedClass CreateInstance() => new NestedClass();

                protected override void ReadValue(NestedClass instance, string name, BsonDeserializationContext context)
                {
                    switch (name)
                    {
                        case "Id":
