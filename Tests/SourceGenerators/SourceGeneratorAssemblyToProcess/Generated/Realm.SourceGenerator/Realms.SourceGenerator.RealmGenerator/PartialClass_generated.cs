...
namespace SourceGeneratorAssemblyToProcess
{
    ...
    public partial class PartialClass : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        static PartialClass()
        {
            Realms.Serialization.RealmObjectSerializer.Register(new PartialClassSerializer());
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class PartialClassManagedAccessor : Realms.ManagedAccessor, IPartialClassAccessor
        {
            public int Id
            {
                get => (int)GetValue("Id");
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class PartialClassUnmanagedAccessor : Realms.UnmanagedAccessor, IPartialClassAccessor
        {
        ...
        private class PartialClassSerializer : Realms.Serialization.RealmObjectSerializer<PartialClass>
        {
            ...
            protected override PartialClass CreateInstance() => new PartialClass();

            protected override void ReadValue(PartialClass instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "Id":
            ...
            protected override void ReadArrayElement(PartialClass instance, string name, BsonDeserializationContext context)
            {
                // No persisted list/set properties to deserialize
            }

            protected override void ReadDocumentField(PartialClass instance, string name, string fieldName, BsonDeserializationContext context)
            {
