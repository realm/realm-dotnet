...
using SourceGeneratorAssemblyToProcess.Realm;
using System;
...
namespace SourceGeneratorAssemblyToProcess.Realm
{
    ...
    public partial class ConfusingNamespaceClass : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        [Realms.Preserve]
        static ConfusingNamespaceClass()
        {
            Realms.Serialization.RealmObjectSerializer.Register(new ConfusingNamespaceClassSerializer());
        }
        ...
        private IConfusingNamespaceClassAccessor? _accessor;
        ...
        {
            var newAccessor = (IConfusingNamespaceClassAccessor)managedAccessor;
        ...
        /// <summary>
        /// Converts a <see cref="Realms.RealmValue"/> to <see cref="ConfusingNamespaceClass"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
        /// </summary>
        /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
        /// <returns>The <see cref="ConfusingNamespaceClass"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
        public static explicit operator ConfusingNamespaceClass?(Realms.RealmValue val) => val.Type == Realms.RealmValueType.Null ? null : val.AsRealmObject<ConfusingNamespaceClass>();

        /// <summary>
        /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="ConfusingNamespaceClass"/>.
        /// </summary>
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="ConfusingNamespaceClass"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(ConfusingNamespaceClass? val) => (Realms.RealmValue)val;
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class ConfusingNamespaceClassManagedAccessor : Realms.ManagedAccessor, IConfusingNamespaceClassAccessor
        {
            public int Id
            {
                get => (int)GetValue("Id");
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class ConfusingNamespaceClassUnmanagedAccessor : Realms.UnmanagedAccessor, IConfusingNamespaceClassAccessor
        {
            ...
            public ConfusingNamespaceClassUnmanagedAccessor(Type objectType) : base(objectType)
            {
            }
        ...
        private class ConfusingNamespaceClassSerializer : Realms.Serialization.RealmObjectSerializerBase<ConfusingNamespaceClass>
        {
            ...
            protected override ConfusingNamespaceClass CreateInstance() => new ConfusingNamespaceClass();

            protected override void ReadValue(ConfusingNamespaceClass instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "Id":
            ...
            protected override void ReadArrayElement(ConfusingNamespaceClass instance, string name, BsonDeserializationContext context)
            {
                // No persisted list/set properties to deserialize
            }

            protected override void ReadDocumentField(ConfusingNamespaceClass instance, string name, string fieldName, BsonDeserializationContext context)
            {
