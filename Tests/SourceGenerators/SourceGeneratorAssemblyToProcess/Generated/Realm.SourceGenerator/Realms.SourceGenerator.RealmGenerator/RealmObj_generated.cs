...
namespace SourceGeneratorPlayground
{
    ...
    public partial class RealmObj : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        static RealmObj()
        {
            Realms.Serialization.RealmObjectSerializer.Register(new RealmObjSerializer());
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class RealmObjManagedAccessor : Realms.ManagedAccessor, IRealmObjAccessor
        {
            public int Id
            {
                get => (int)GetValue("Id");
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class RealmObjUnmanagedAccessor : Realms.UnmanagedAccessor, IRealmObjAccessor
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class RealmObjSerializer : Realms.Serialization.RealmObjectSerializerBase<RealmObj>
        {
            public override string SchemaName => "RealmObj";

            protected override void SerializeValue(MongoDB.Bson.Serialization.BsonSerializationContext context, BsonSerializationArgs args, RealmObj value)
            {
            ...
            protected override RealmObj CreateInstance() => new RealmObj();

            protected override void ReadValue(RealmObj instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "Id":
            ...
            protected override void ReadArrayElement(RealmObj instance, string name, BsonDeserializationContext context)
            {
                // No persisted list/set properties to deserialize
            }

            protected override void ReadDocumentField(RealmObj instance, string name, string fieldName, BsonDeserializationContext context)
            {
