...
public partial class AsymmetricTestClass : IAsymmetricObject, INotifyPropertyChanged, IReflectableType
{
    ...
    [Realms.Preserve]
    static AsymmetricTestClass()
    {
        Realms.Serialization.RealmObjectSerializer.Register(new AsymmetricTestClassSerializer());
    }
    ...
    [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
    private class AsymmetricTestClassManagedAccessor : Realms.ManagedAccessor, IAsymmetricTestClassAccessor
    {
    ...
    [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
    private class AsymmetricTestClassUnmanagedAccessor : Realms.UnmanagedAccessor, IAsymmetricTestClassAccessor
    {
    ...
    [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
    private class AsymmetricTestClassSerializer : Realms.Serialization.RealmObjectSerializerBase<AsymmetricTestClass>
    {
        public override string SchemaName => "AsymmetricTestClass";

        protected override void SerializeValue(MongoDB.Bson.Serialization.BsonSerializationContext context, BsonSerializationArgs args, AsymmetricTestClass value)
        {
        ...
        protected override AsymmetricTestClass CreateInstance() => new AsymmetricTestClass();

        protected override void ReadValue(AsymmetricTestClass instance, string name, BsonDeserializationContext context)
        {
            switch (name)
            {
                case "Int32Property":
        ...
        protected override void ReadArrayElement(AsymmetricTestClass instance, string name, BsonDeserializationContext context)
        {
            // No persisted list/set properties to deserialize
        }

        protected override void ReadDocumentField(AsymmetricTestClass instance, string name, string fieldName, BsonDeserializationContext context)
        {
