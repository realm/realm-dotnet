...
public partial class JustForObjectReference : IRealmObject, INotifyPropertyChanged, IReflectableType
{
    ...
    [Realms.Preserve]
    static JustForObjectReference()
    {
        Realms.Serialization.RealmObjectSerializer.Register(new JustForObjectReferenceSerializer());
    }
    ...
    private IJustForObjectReferenceAccessor? _accessor;
    ...
    void ISettableManagedAccessor.SetManagedAccessor(Realms.IRealmAccessor managedAccessor, Realms.Weaving.IRealmObjectHelper? helper, bool update, bool skipDefaults)
    {
        ...
        if (helper != null && oldAccessor != null)
        {
            ...
            newAccessor.UseAsBacklink = oldAccessor.UseAsBacklink;
        }
    ...
    private class JustForObjectReferenceObjectHelper : Realms.Weaving.IRealmObjectHelper
    {
        ...
        public Realms.ManagedAccessor CreateAccessor() => new JustForObjectReferenceManagedAccessor();
    ...
    [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
    private class JustForObjectReferenceManagedAccessor : Realms.ManagedAccessor, IJustForObjectReferenceAccessor
    {
        public RootRealmClass? UseAsBacklink
        {
            get => (RootRealmClass?)GetValue("UseAsBacklink");
            set => SetValue("UseAsBacklink", value);
        }
    }
    ...
    private class JustForObjectReferenceUnmanagedAccessor : Realms.UnmanagedAccessor, IJustForObjectReferenceAccessor
    {
        ...
        private RootRealmClass? _useAsBacklink;
        public RootRealmClass? UseAsBacklink
        {
            get => _useAsBacklink;
            set
            {
                _useAsBacklink = value;
                RaisePropertyChanged("UseAsBacklink");
            }
        }

        public JustForObjectReferenceUnmanagedAccessor(Type objectType) : base(objectType)
        {
        }
        ...
        public override void SetValue(string propertyName, Realms.RealmValue val)
        {
            ...
            {
                case "UseAsBacklink":
                    UseAsBacklink = (RootRealmClass?)val;
                    return;
                default:
    ...
    [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
    private class JustForObjectReferenceSerializer : Realms.Serialization.RealmObjectSerializerBase<JustForObjectReference>
    {
        public override string SchemaName => "JustForObjectReference";

        protected override void SerializeValue(MongoDB.Bson.Serialization.BsonSerializationContext context, BsonSerializationArgs args, JustForObjectReference value)
        {
            context.Writer.WriteStartDocument();

            WriteValue(context, args, "UseAsBacklink", value.UseAsBacklink);

            context.Writer.WriteEndDocument();
        }

        protected override JustForObjectReference CreateInstance() => new JustForObjectReference();

        protected override void ReadValue(JustForObjectReference instance, string name, BsonDeserializationContext context)
        {
            switch (name)
            {
                case "UseAsBacklink":
                    instance.UseAsBacklink = Realms.Serialization.RealmObjectSerializer.LookupSerializer<RootRealmClass?>()!.DeserializeById(context);
                    break;
                default:
        ...
        protected override void ReadArrayElement(JustForObjectReference instance, string name, BsonDeserializationContext context)
        {
            // No persisted list/set properties to deserialize
        }

        protected override void ReadDocumentField(JustForObjectReference instance, string name, string fieldName, BsonDeserializationContext context)
        {
