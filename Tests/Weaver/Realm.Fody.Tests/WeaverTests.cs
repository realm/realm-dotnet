    ...
    public class Tests : WeaverTestBase
    {
        ...
        public void MatchErrorsAndWarnings()
        {
            ...
            var expectedErrors = new[]
            {
                ...
                "IndexedProperties.FullTextIntProperty is marked as [Indexed(IndexMode.FullText)] which is only allowed on string properties, not on System.Int32.",
                "IndexedProperties.NoneIntProperty is marked as [Indexed(IndexMode.None)] which is not allowed. If you don't wish to index the property, remove the IndexedAttribute.",
