...
namespace Realms.Tests.Database
{
    ...
    public class CollectionTests : RealmInstanceTest
    {
        ...
        {
            new object[] { new FtsTestData("lord of the", LordOfTheFlies, LordOfTheRings) },
            new object[] { new FtsTestData("fantasy novel", LordOfTheFlies, WheelOfTime) },
            new object[] { new FtsTestData("popular english", LordOfTheRings, AnimalFarm, Silmarillion) },
        };
