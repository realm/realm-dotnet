    ...
    public class DynamicEmbeddedTests : RealmInstanceTest
    {
        ...
        public void CreateObject_WhenEmbedded_CanAssignToParent()
        {
            RunTestInAllModes(realm =>
            {
                ...
                realm.Write(() =>
                {
                    var parent = realm.DynamicApi.CreateObject(nameof(DynamicTask), id);
        ...
        public void ListAdd_WhenEmbedded_Throws()
        {
            RunTestInAllModes(realm =>
            {
                var ex = Assert.Throws<NotSupportedException>(() =>
                {
                    realm.Write(() =>
                    {
                        var parent = realm.DynamicApi.CreateObject(nameof(DynamicTask), Guid.NewGuid().ToString());
        ...
        public void RealmAddEmbeddedObjectToList()
        {
            RunTestInAllModes(realm =>
            {
                ...
                realm.Write(() =>
                {
                    var parent = realm.DynamicApi.CreateObject(nameof(DynamicTask), id);
                    var subTasks = parent.DynamicApi.GetList<IEmbeddedObject>(nameof(DynamicTask.SubTasks));
                    var subTask = realm.DynamicApi.AddEmbeddedObjectToList(subTasks);
                ...
                realm.Write(() =>
                {
                    var secondSubTask = realm.DynamicApi.AddEmbeddedObjectToList(addedSubTasks);
                    ...
                    var secondLevelSubTask = realm.DynamicApi.AddEmbeddedObjectToList(subSubTasks);
                ...
                TestHelpers.RunDynamicTest(() =>
                {
                    ...
                    realm.Write(() =>
                    {
                        ...
                        var subTask = realm.DynamicApi.AddEmbeddedObjectToList(parent.SubTasks);
                    ...
                    realm.Write(() =>
                    {
                        var secondSubTask = realm.DynamicApi.AddEmbeddedObjectToList(dynamicParent.SubTasks);
                        secondSubTask.Summary = "This is a second subtask level 1";

                        var secondLevelSubTask = realm.DynamicApi.AddEmbeddedObjectToList(dynamicParent.SubTasks[0].SubSubTasks);
        ...
        public void RealmAddEmbeddedObjectToDictionary()
        {
            ...
            RunTestInAllModes(realm =>
            {
                ...
                realm.Write(() =>
                {
                    ...
                    var subTask = realm.DynamicApi.AddEmbeddedObjectToDictionary(dict, "foo");
                    subTask.DynamicApi.Set(nameof(DynamicSubTask.Summary), "This is subtask level 1");
                });
                ...
                realm.Write(() =>
                {
                    var secondSubTask = realm.DynamicApi.AddEmbeddedObjectToDictionary(addedDict, "bar");
                    secondSubTask.DynamicApi.Set(nameof(DynamicSubTask.Summary), "This is a second subtask level 1");
                });
                ...
                TestHelpers.RunDynamicTest(() =>
                {
                    ...
                    realm.Write(() =>
                    {
                        ...
                        var subTask = realm.DynamicApi.AddEmbeddedObjectToDictionary(parent.SubTasksDictionary, "foo");
                        subTask.Summary = "This is subtask level 1";
                    });
                    ...
                    realm.Write(() =>
                    {
                        var secondSubTask = realm.DynamicApi.AddEmbeddedObjectToDictionary(dynamicAddedParent.SubTasksDictionary, "bar");
                        secondSubTask.Summary = "This is a second subtask level 1";
                    });
        ...
        public void RealmInsertEmbeddedObjectInList()
        {
            RunTestInAllModes(realm =>
            {
                ...
                realm.Write(() =>
                {
                    ...
                    var subTask = realm.DynamicApi.InsertEmbeddedObjectInList(list, 0);
                ...
                realm.Write(() =>
                {
                    var insertAt0 = realm.DynamicApi.InsertEmbeddedObjectInList(subTasks, 0);
                    ...
                    var insertAt2 = realm.DynamicApi.InsertEmbeddedObjectInList(subTasks, 2);
                ...
                TestHelpers.RunDynamicTest(() =>
                {
                    ...
                    realm.Write(() =>
                    {
                        ...
                        var subTask = realm.DynamicApi.InsertEmbeddedObjectInList(parent.SubTasks, 0);
                    ...
                    realm.Write(() =>
                    {
                        var insertAt0 = realm.DynamicApi.InsertEmbeddedObjectInList(dynamicAddedParent.SubTasks, 0);
                        insertAt0.Summary = "This is now at 0";

                        dynamicAddedParent.SubTasks[1].Summary = "This is now at 1";

                        var insertAt2 = realm.DynamicApi.InsertEmbeddedObjectInList(dynamicAddedParent.SubTasks, 2);
        ...
        public void RealmSetEmbeddedObjectInList()
        {
            RunTestInAllModes(realm =>
            {
                ...
                realm.Write(() =>
                {
                    ...
                    var task0 = realm.DynamicApi.AddEmbeddedObjectToList(subTasks);
                    var task1 = realm.DynamicApi.AddEmbeddedObjectToList(subTasks);
                    var task2 = realm.DynamicApi.AddEmbeddedObjectToList(subTasks);
                ...
                realm.Write(() =>
                {
                    var newAt1 = realm.DynamicApi.SetEmbeddedObjectInList(addedSubTasks, 1);
                ...
                TestHelpers.RunDynamicTest(() =>
                {
                    ...
                    realm.Write(() =>
                    {
                        ...
                        var task0 = realm.DynamicApi.AddEmbeddedObjectToList(parent.SubTasks);
                        var task1 = realm.DynamicApi.AddEmbeddedObjectToList(parent.SubTasks);
                        var task2 = realm.DynamicApi.AddEmbeddedObjectToList(parent.SubTasks);
                    ...
                    realm.Write(() =>
                    {
                        var newAt1 = realm.DynamicApi.SetEmbeddedObjectInList(dynamicParent.SubTasks, 1);
        ...
        public void RealmSetEmbeddedObjectInDictionary()
        {
            RunTestInAllModes(realm =>
            {
                ...
                realm.Write(() =>
                {
                    ...
                    var dict = parent.DynamicApi.GetDictionary<IEmbeddedObject>(nameof(DynamicTask.SubTasksDictionary));
                    var task0 = realm.DynamicApi.AddEmbeddedObjectToDictionary(dict, "a");
                    var task1 = realm.DynamicApi.AddEmbeddedObjectToDictionary(dict, "b");
                    var task2 = realm.DynamicApi.AddEmbeddedObjectToDictionary(dict, "c");
                ...
                realm.Write(() =>
                {
                    var newAt1 = realm.DynamicApi.SetEmbeddedObjectInDictionary(subTasks, "b");
                ...
                TestHelpers.RunDynamicTest(() =>
                {
                    ...
                    realm.Write(() =>
                    {
                        ...
                        var task0 = realm.DynamicApi.AddEmbeddedObjectToDictionary(parent.SubTasksDictionary, "a");
                        var task1 = realm.DynamicApi.AddEmbeddedObjectToDictionary(parent.SubTasksDictionary, "b");
                        var task2 = realm.DynamicApi.AddEmbeddedObjectToDictionary(parent.SubTasksDictionary, "c");
                    ...
                    realm.Write(() =>
                    {
                        var newAt1 = realm.DynamicApi.SetEmbeddedObjectInDictionary(dynamicParent.SubTasksDictionary, "b");
        ...
        public void List_RemoveAt()
        {
            RunTestInAllModes(realm =>
            {
                ...
                realm.Write(() =>
                {
                    ...
                    var first = realm.DynamicApi.AddEmbeddedObjectToList(list);
                    var second = realm.DynamicApi.AddEmbeddedObjectToList(list);
                ...
                TestHelpers.RunDynamicTest(() =>
                {
                    ...
                    {
                        dynamic parent = realm.DynamicApi.CreateObject(nameof(DynamicTask), dynamicId);
                        var first = realm.DynamicApi.AddEmbeddedObjectToList(parent.SubTasks);
                        var second = realm.DynamicApi.AddEmbeddedObjectToList(parent.SubTasks);
        ...
        public void Dictionary_Remove()
        {
            ...
            RunTestInAllModes(realm =>
            {
                ...
                var second = realm.Write(() =>
                {
                    var parent = realm.DynamicApi.CreateObject(nameof(DynamicTask), id);
                    var dict = parent.DynamicApi.GetDictionary<IEmbeddedObject>(nameof(DynamicTask.SubTasksDictionary));
                    var first = realm.DynamicApi.AddEmbeddedObjectToDictionary(dict, "first");
                    var second = realm.DynamicApi.AddEmbeddedObjectToDictionary(dict, "second");
                ...
                TestHelpers.RunDynamicTest(() =>
                {
                    ...
                    {
                        dynamic parent = realm.DynamicApi.CreateObject(nameof(DynamicTask), dynamicId);
                        var first = realm.DynamicApi.AddEmbeddedObjectToDictionary(parent.SubTasksDictionary, "first");
                        var second = realm.DynamicApi.AddEmbeddedObjectToDictionary(parent.SubTasksDictionary, "second");
        ...
        public void Embedded_Backlinks()
        {
            RunTestInAllModes(realm =>
            {
                ...
                realm.Write(() =>
                {
                    var task = realm.DynamicApi.CreateObject(nameof(DynamicTask), id);
                ...
                TestHelpers.RunDynamicTest(() =>
                {
                    ...
                    realm.Write(() =>
                    {
                        ...
                        var subTask = realm.DynamicApi.AddEmbeddedObjectToList(task.SubTasks);
                    ...
                    var dynamicSubTask = dynamicTask.SubTasks[0];
                    var dynamicSubSubTask1 = dynamicTask.SubSubTasks[0];
                    var dynamicSubSubTask2 = dynamicSubTask.SubSubTasks[0];
        ...
        public void Embedded_DynamicBacklinks()
        {
            RunTestInAllModes(realm =>
            {
                ...
                realm.Write(() =>
                {
                    ...
                    var report = realm.DynamicApi.CreateEmbeddedObjectForProperty(task, nameof(DynamicTask.CompletionReport));
                ...
                TestHelpers.RunDynamicTest(() =>
                {
                    ...
                    dynamic dynamicTask = realm.DynamicApi.Find(nameof(DynamicTask), dynamicId)!;
                    var dynamicReport = dynamicTask.CompletionReport;
