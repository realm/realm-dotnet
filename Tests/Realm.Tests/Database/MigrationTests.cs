...
namespace Realms.Tests.Database
{
    ...
    public class MigrationTests : RealmInstanceTest
    {
        ...
        public void TriggerMigrationBySchemaEditing()
        {
            ...
            var path = TransformHelpers.CopyBundledFileToDocuments(FileToMigrate, typeof(TestHelpers).Assembly, Path.Combine(InteropConfig.DefaultStorageFolder, Guid.NewGuid().ToString()));
