    ...
    public class UserManagementTests : SyncTestBase
    {
        ...
        public void UserCustomData()
        {
            SyncTestHelpers.RunBaasTestAsync(async () =>
            {
                ...
                var collection = user.GetMongoClient("BackingDB").GetDatabase(SyncTestHelpers.CustomUserDataDB).GetCollection("users");
        ...
        public void UserCustomData_Generic()
        {
            SyncTestHelpers.RunBaasTestAsync(async () =>
            {
                ...
                var collection = user.GetMongoClient("BackingDB").GetDatabase(SyncTestHelpers.CustomUserDataDB).GetCollection<CustomDataDocument>("users");
