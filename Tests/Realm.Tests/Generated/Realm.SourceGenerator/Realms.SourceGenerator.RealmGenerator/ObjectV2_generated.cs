...
namespace Realms.Tests.Database
{
    ...
    public partial class ObjectV2 : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        static ObjectV2()
        {
            ...
            Realms.Sync.MongoClient.RegisterSchema(typeof(ObjectV2), RealmSchema);
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class ObjectV2Serializer : Realms.Serialization.RealmObjectSerializerBase<ObjectV2>
        {
