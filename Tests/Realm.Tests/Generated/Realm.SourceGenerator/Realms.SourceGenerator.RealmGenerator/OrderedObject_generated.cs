...
namespace Realms.Tests.Database
{
    ...
    public partial class OrderedObject : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        [Realms.Preserve]
        static OrderedObject()
        {
            Realms.Serialization.RealmObjectSerializer.Register(new OrderedObjectSerializer());
            Realms.Sync.MongoClient.RegisterSchema(typeof(OrderedObject), RealmSchema);
        }
        ...
        public static Realms.Schema.ObjectSchema RealmSchema = new Realms.Schema.ObjectSchema.Builder("OrderedObject", ObjectSchema.ObjectType.RealmObject)
        {
            ...
            Realms.Schema.Property.Primitive("IsPartOfResults", Realms.RealmValueType.Bool, isPrimaryKey: false, indexType: IndexType.None, isNullable: false, managedName: "IsPartOfResults"),
        }.Build();
        ...
        private IOrderedObjectAccessor Accessor => _accessor ??= new OrderedObjectUnmanagedAccessor(typeof(OrderedObject));
        ...
        /// <summary>
        /// Converts a <see cref="Realms.RealmValue"/> to <see cref="OrderedObject"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
        /// </summary>
        /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
        /// <returns>The <see cref="OrderedObject"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="OrderedObject"/>.
        /// </summary>
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="OrderedObject"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(OrderedObject? val) => (Realms.RealmValue)val;
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class OrderedObjectManagedAccessor : Realms.ManagedAccessor, IOrderedObjectAccessor
        {
            public int Order
            {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class OrderedObjectUnmanagedAccessor : Realms.UnmanagedAccessor, IOrderedObjectAccessor
        {
        ...
        private class OrderedObjectSerializer : Realms.Serialization.RealmObjectSerializerBase<OrderedObject>
        {
            ...
            protected override void SerializeValue(MongoDB.Bson.Serialization.BsonSerializationContext context, BsonSerializationArgs args, OrderedObject value)
            {
                ...
                WriteValue(context, args, "Order", value.Order);
                WriteValue(context, args, "IsPartOfResults", value.IsPartOfResults);

                context.Writer.WriteEndDocument();
            }

            protected override OrderedObject CreateInstance() => new OrderedObject();

            protected override void ReadValue(OrderedObject instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "Order":
                        instance.Order = BsonSerializer.LookupSerializer<int>().Deserialize(context);
                        break;
                    case "IsPartOfResults":
            ...
            protected override void ReadArrayElement(OrderedObject instance, string name, BsonDeserializationContext context)
            {
                // No persisted list/set properties to deserialize
            }

            protected override void ReadDocumentField(OrderedObject instance, string name, string fieldName, BsonDeserializationContext context)
            {
