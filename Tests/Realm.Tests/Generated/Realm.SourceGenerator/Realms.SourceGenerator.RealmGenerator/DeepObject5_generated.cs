...
namespace Realms.Tests.Database
{
    ...
    public partial class DeepObject5 : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        /// <summary>
        /// Defines the schema for the <see cref="DeepObject5"/> class.
        /// </summary>
        [System.Reflection.Obfuscation]
        public static Realms.Schema.ObjectSchema RealmSchema = new Realms.Schema.ObjectSchema.Builder("DeepObject5", ObjectSchema.ObjectType.RealmObject)
        {
        ...
        private IDeepObject5Accessor? _accessor;

        Realms.IRealmAccessor Realms.IRealmObjectBase.Accessor => Accessor;

        private IDeepObject5Accessor Accessor => _accessor ??= new DeepObject5UnmanagedAccessor(typeof(DeepObject5));
        ...
        {
            var newAccessor = (IDeepObject5Accessor)managedAccessor;
        ...
        /// <summary>
        /// Converts a <see cref="Realms.RealmValue"/> to <see cref="DeepObject5"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
        /// </summary>
        /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
        /// <returns>The <see cref="DeepObject5"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
        public static explicit operator DeepObject5?(Realms.RealmValue val) => val.Type == Realms.RealmValueType.Null ? null : val.AsRealmObject<DeepObject5>();

        /// <summary>
        /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="DeepObject5"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.RealmValue"/>.</param>
        /// <returns>A <see cref="Realms.RealmValue"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.RealmValue(DeepObject5? val) => val == null ? Realms.RealmValue.Null : Realms.RealmValue.Object(val);

        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="DeepObject5"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(DeepObject5? val) => (Realms.RealmValue)val;
        ...
        private class DeepObject5ObjectHelper : Realms.Weaving.IRealmObjectHelper
        {
            ...
            public Realms.ManagedAccessor CreateAccessor() => new DeepObject5ManagedAccessor();

            public Realms.IRealmObjectBase CreateInstance() => new DeepObject5();
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        internal interface IDeepObject5Accessor : Realms.IRealmAccessor
        {
        ...
        private class DeepObject5UnmanagedAccessor : Realms.UnmanagedAccessor, IDeepObject5Accessor
        {
            ...
            public DeepObject5UnmanagedAccessor(Type objectType) : base(objectType)
            {
            }
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class DeepObject5Serializer : Realms.Serialization.RealmObjectSerializerBase<DeepObject5>
        {
