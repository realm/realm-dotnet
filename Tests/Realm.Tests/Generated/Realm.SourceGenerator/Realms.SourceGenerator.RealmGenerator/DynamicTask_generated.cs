...
namespace Realms.Tests.Database
{
    ...
    public partial class DynamicTask : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class DynamicTaskManagedAccessor : Realms.ManagedAccessor, IDynamicTaskAccessor
        {
            public string? Id
            {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class DynamicTaskUnmanagedAccessor : Realms.UnmanagedAccessor, IDynamicTaskAccessor
        {
        ...
        private class DynamicTaskSerializer : Realms.Serialization.RealmObjectSerializer<DynamicTask>
        {
            protected override void SerializeValue(MongoDB.Bson.Serialization.BsonSerializationContext context, BsonSerializationArgs args, DynamicTask value)
            {
                ...
                WriteList(context, args, "SubTasks", value.SubTasks);
                WriteList(context, args, "SubSubTasks", value.SubSubTasks);
                WriteDictionary(context, args, "SubTasksDictionary", value.SubTasksDictionary);

                context.Writer.WriteEndDocument();
            }

            protected override DynamicTask CreateInstance() => new DynamicTask();

            protected override void ReadValue(DynamicTask instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "Id":
            ...
            protected override void ReadArrayElement(DynamicTask instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "SubTasks":
