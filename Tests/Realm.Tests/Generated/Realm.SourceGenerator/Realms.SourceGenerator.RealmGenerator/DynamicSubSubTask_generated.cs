...
namespace Realms.Tests.Database
{
    ...
    public partial class DynamicSubSubTask : IEmbeddedObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        static DynamicSubSubTask()
        {
            ...
            Realms.Sync.MongoClient.RegisterSchema(typeof(DynamicSubSubTask), RealmSchema);
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class DynamicSubSubTaskSerializer : Realms.Serialization.RealmObjectSerializerBase<DynamicSubSubTask>
        {
