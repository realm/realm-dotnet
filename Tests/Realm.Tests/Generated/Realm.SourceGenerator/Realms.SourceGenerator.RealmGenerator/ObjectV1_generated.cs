...
namespace Realms.Tests.Database
{
    ...
    public partial class ObjectV1 : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        static ObjectV1()
        {
            Realms.Serialization.RealmObjectSerializer.Register(new ObjectV1Serializer());
            Realms.Sync.MongoClient.RegisterSchema(typeof(ObjectV1), RealmSchema);
        }
        ...
        private IObjectV1Accessor Accessor => _accessor ??= new ObjectV1UnmanagedAccessor(typeof(ObjectV1));
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="ObjectV1"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(ObjectV1? val) => (Realms.RealmValue)val;
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class ObjectV1ManagedAccessor : Realms.ManagedAccessor, IObjectV1Accessor
        {
            public int Id
            {
                get => (int)GetValue("Id");
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class ObjectV1UnmanagedAccessor : Realms.UnmanagedAccessor, IObjectV1Accessor
        {
        ...
        private class ObjectV1Serializer : Realms.Serialization.RealmObjectSerializerBase<ObjectV1>
        {
            ...
            protected override void SerializeValue(MongoDB.Bson.Serialization.BsonSerializationContext context, BsonSerializationArgs args, ObjectV1 value)
            {
            ...
            protected override ObjectV1 CreateInstance() => new ObjectV1();

            protected override void ReadValue(ObjectV1 instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "Id":
            ...
            protected override void ReadArrayElement(ObjectV1 instance, string name, BsonDeserializationContext context)
            {
                // No persisted list/set properties to deserialize
            }

            protected override void ReadDocumentField(ObjectV1 instance, string name, string fieldName, BsonDeserializationContext context)
            {
