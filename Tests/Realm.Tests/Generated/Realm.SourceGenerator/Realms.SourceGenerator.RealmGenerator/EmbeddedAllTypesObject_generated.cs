...
namespace Realms.Tests
{
    ...
    public partial class EmbeddedAllTypesObject : IEmbeddedObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        public static Realms.Schema.ObjectSchema RealmSchema = new Realms.Schema.ObjectSchema.Builder("EmbeddedAllTypesObject", ObjectSchema.ObjectType.EmbeddedObject)
        {
            ...
            Realms.Schema.Property.Primitive("NullableByteCounterProperty", Realms.RealmValueType.Int, isPrimaryKey: false, indexType: IndexType.None, isNullable: true, managedName: "NullableByteCounterProperty"),
            Realms.Schema.Property.Primitive("NullableInt16CounterProperty", Realms.RealmValueType.Int, isPrimaryKey: false, indexType: IndexType.None, isNullable: true, managedName: "NullableInt16CounterProperty"),
            Realms.Schema.Property.Primitive("NullableInt32CounterProperty", Realms.RealmValueType.Int, isPrimaryKey: false, indexType: IndexType.None, isNullable: true, managedName: "NullableInt32CounterProperty"),
            Realms.Schema.Property.Primitive("NullableInt64CounterProperty", Realms.RealmValueType.Int, isPrimaryKey: false, indexType: IndexType.None, isNullable: true, managedName: "NullableInt64CounterProperty"),
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="EmbeddedAllTypesObject"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(EmbeddedAllTypesObject? val) => (Realms.RealmValue)val;
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class EmbeddedAllTypesObjectManagedAccessor : Realms.ManagedAccessor, IEmbeddedAllTypesObjectAccessor
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class EmbeddedAllTypesObjectUnmanagedAccessor : Realms.UnmanagedAccessor, IEmbeddedAllTypesObjectAccessor
        {
        ...
        private class EmbeddedAllTypesObjectSerializer : Realms.Serialization.RealmObjectSerializer<EmbeddedAllTypesObject>
        {
            protected override void SerializeValue(MongoDB.Bson.Serialization.BsonSerializationContext context, BsonSerializationArgs args, EmbeddedAllTypesObject value)
            {
                ...
                WriteValue(context, args, "NullableByteCounterProperty", value.NullableByteCounterProperty);
                WriteValue(context, args, "NullableInt16CounterProperty", value.NullableInt16CounterProperty);
                WriteValue(context, args, "NullableInt32CounterProperty", value.NullableInt32CounterProperty);
                WriteValue(context, args, "NullableInt64CounterProperty", value.NullableInt64CounterProperty);

                context.Writer.WriteEndDocument();
            }

            protected override EmbeddedAllTypesObject CreateInstance() => new EmbeddedAllTypesObject();

            protected override void ReadValue(EmbeddedAllTypesObject instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "CharProperty":
                    ...
                    case "Int64CounterProperty":
                        ...
                        break;
                    case "NullableByteCounterProperty":
                        instance.NullableByteCounterProperty = BsonSerializer.LookupSerializer<Realms.RealmInteger<byte>?>().Deserialize(context);
                        break;
                    case "NullableInt16CounterProperty":
                        instance.NullableInt16CounterProperty = BsonSerializer.LookupSerializer<Realms.RealmInteger<short>?>().Deserialize(context);
                        break;
                    case "NullableInt32CounterProperty":
                        instance.NullableInt32CounterProperty = BsonSerializer.LookupSerializer<Realms.RealmInteger<int>?>().Deserialize(context);
                        break;
                    case "NullableInt64CounterProperty":
            ...
            protected override void ReadArrayElement(EmbeddedAllTypesObject instance, string name, BsonDeserializationContext context)
            {
                // No persisted list/set properties to deserialize
            }

            protected override void ReadDocumentField(EmbeddedAllTypesObject instance, string name, string fieldName, BsonDeserializationContext context)
            {
