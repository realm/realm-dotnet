...
namespace Realms.Tests
{
    ...
    public partial class IntPrimaryKeyWithValueObject : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        internal IIntPrimaryKeyWithValueObjectAccessor Accessor => _accessor ??= new IntPrimaryKeyWithValueObjectUnmanagedAccessor(typeof(IntPrimaryKeyWithValueObject));
        ...
        /// <summary>
        /// Converts a <see cref="Realms.RealmValue"/> to <see cref="IntPrimaryKeyWithValueObject"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
        /// </summary>
        /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
        /// <returns>The <see cref="IntPrimaryKeyWithValueObject"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
        public static explicit operator IntPrimaryKeyWithValueObject?(Realms.RealmValue val) => val.Type == Realms.RealmValueType.Null ? null : val.AsRealmObject<IntPrimaryKeyWithValueObject>();

        /// <summary>
        /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="IntPrimaryKeyWithValueObject"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.RealmValue"/>.</param>
        /// <returns>A <see cref="Realms.RealmValue"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.RealmValue(IntPrimaryKeyWithValueObject? val) => val == null ? Realms.RealmValue.Null : Realms.RealmValue.Object(val);

        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="IntPrimaryKeyWithValueObject"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(IntPrimaryKeyWithValueObject? val) => (Realms.RealmValue)val;
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class IntPrimaryKeyWithValueObjectManagedAccessor : Realms.ManagedAccessor, IIntPrimaryKeyWithValueObjectAccessor
        {
            public int Id
            {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class IntPrimaryKeyWithValueObjectUnmanagedAccessor : Realms.UnmanagedAccessor, IIntPrimaryKeyWithValueObjectAccessor
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class IntPrimaryKeyWithValueObjectSerializer : Realms.Serialization.RealmObjectSerializer<IntPrimaryKeyWithValueObject>
        {
