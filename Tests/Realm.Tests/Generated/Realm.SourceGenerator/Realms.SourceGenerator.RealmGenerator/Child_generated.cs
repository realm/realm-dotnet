...
namespace Realms.Tests.Database
{
    public partial class AddOrUpdateTests
    {
        ...
        public partial class Child : IRealmObject, INotifyPropertyChanged, IReflectableType
        {
            ...
            static Child()
            {
                Realms.Serialization.RealmObjectSerializer.Register(new ChildSerializer());
                Realms.Sync.MongoClient.RegisterSchema(typeof(Child), RealmSchema);
            }

            /// <summary>
            /// Defines the schema for the <see cref="Child"/> class.
            /// </summary>
            ...
            private IChildAccessor Accessor => _accessor ??= new ChildUnmanagedAccessor(typeof(Child));
            ...
            /// <summary>
            /// Converts a <see cref="Realms.RealmValue"/> to <see cref="Child"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
            /// </summary>
            /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
            /// <returns>The <see cref="Child"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
            ...
            /// <summary>
            /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="Child"/>.
            /// </summary>
            ...
            /// <summary>
            /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="Child"/>.
            /// </summary>
            /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
            /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
            public static implicit operator Realms.QueryArgument(Child? val) => (Realms.RealmValue)val;
            ...
            [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
            private class ChildManagedAccessor : Realms.ManagedAccessor, IChildAccessor
            {
                public long Id
                {
            ...
            [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
            private class ChildUnmanagedAccessor : Realms.UnmanagedAccessor, IChildAccessor
            {
            ...
            private class ChildSerializer : Realms.Serialization.RealmObjectSerializerBase<Child>
            {
                ...
                protected override Child CreateInstance() => new Child();

                protected override void ReadValue(Child instance, string name, BsonDeserializationContext context)
                {
                    switch (name)
                    {
                        case "Id":
                ...
                protected override void ReadArrayElement(Child instance, string name, BsonDeserializationContext context)
                {
                    // No persisted list/set properties to deserialize
                }

                protected override void ReadDocumentField(Child instance, string name, string fieldName, BsonDeserializationContext context)
                {
