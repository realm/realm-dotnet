...
namespace Realms.Tests.Database
{
    ...
    public partial class AgedObject : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        /// <summary>
        /// Defines the schema for the <see cref="AgedObject"/> class.
        /// </summary>
        ...
        internal IAgedObjectAccessor Accessor => _accessor ??= new AgedObjectUnmanagedAccessor(typeof(AgedObject));
        ...
        /// <summary>
        /// Converts a <see cref="Realms.RealmValue"/> to <see cref="AgedObject"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
        /// </summary>
        /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
        /// <returns>The <see cref="AgedObject"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="AgedObject"/>.
        /// </summary>
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class AgedObjectManagedAccessor : Realms.ManagedAccessor, IAgedObjectAccessor
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class AgedObjectUnmanagedAccessor : Realms.UnmanagedAccessor, IAgedObjectAccessor
        {
        ...
        private class AgedObjectSerializer : Realms.Serialization.RealmObjectSerializer<AgedObject>
        {
            ...
            protected override AgedObject CreateInstance() => new AgedObject();

            protected override void ReadValue(AgedObject instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "Birthday":
            ...
            protected override void ReadArrayElement(AgedObject instance, string name, BsonDeserializationContext context)
            {
                // No persisted list/set properties to deserialize
            }

            protected override void ReadDocumentField(AgedObject instance, string name, string fieldName, BsonDeserializationContext context)
            {
