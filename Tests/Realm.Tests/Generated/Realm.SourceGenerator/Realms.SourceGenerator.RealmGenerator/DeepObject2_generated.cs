...
namespace Realms.Tests.Database
{
    ...
    public partial class DeepObject2 : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        public static Realms.Schema.ObjectSchema RealmSchema = new Realms.Schema.ObjectSchema.Builder("DeepObject2", ObjectSchema.ObjectType.RealmObject)
        {
            ...
            Realms.Schema.Property.Object("RecursiveObject", "DeepObject3", managedName: "RecursiveObject"),
        }.Build();

        #region IRealmObject implementation

        private IDeepObject2Accessor? _accessor;

        Realms.IRealmAccessor Realms.IRealmObjectBase.Accessor => Accessor;

        private IDeepObject2Accessor Accessor => _accessor ??= new DeepObject2UnmanagedAccessor(typeof(DeepObject2));
        ...
        {
            var newAccessor = (IDeepObject2Accessor)managedAccessor;
        ...
        /// <summary>
        /// Converts a <see cref="Realms.RealmValue"/> to <see cref="DeepObject2"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
        /// </summary>
        /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
        /// <returns>The <see cref="DeepObject2"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
        public static explicit operator DeepObject2?(Realms.RealmValue val) => val.Type == Realms.RealmValueType.Null ? null : val.AsRealmObject<DeepObject2>();

        /// <summary>
        /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="DeepObject2"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.RealmValue"/>.</param>
        /// <returns>A <see cref="Realms.RealmValue"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.RealmValue(DeepObject2? val) => val == null ? Realms.RealmValue.Null : Realms.RealmValue.Object(val);

        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="DeepObject2"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(DeepObject2? val) => (Realms.RealmValue)val;
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        internal interface IDeepObject2Accessor : Realms.IRealmAccessor
        {
            string? StringValue { get; set; }

            Realms.Tests.Database.DeepObject3? RecursiveObject { get; set; }
        }
        ...
        private class DeepObject2ManagedAccessor : Realms.ManagedAccessor, IDeepObject2Accessor
        {
            ...
            public Realms.Tests.Database.DeepObject3? RecursiveObject
            {
                get => (Realms.Tests.Database.DeepObject3?)GetValue("RecursiveObject");
        ...
        private class DeepObject2UnmanagedAccessor : Realms.UnmanagedAccessor, IDeepObject2Accessor
        {
            ...
            private Realms.Tests.Database.DeepObject3? _recursiveObject;
            public Realms.Tests.Database.DeepObject3? RecursiveObject
            {
            ...
            public DeepObject2UnmanagedAccessor(Type objectType) : base(objectType)
            {
            }
            ...
            public override void SetValue(string propertyName, Realms.RealmValue val)
            {
                switch (propertyName)
                {
                    ...
                    case "RecursiveObject":
                        RecursiveObject = (Realms.Tests.Database.DeepObject3?)val;
                        return;
                    default:
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class DeepObject2Serializer : Realms.Serialization.RealmObjectSerializerBase<DeepObject2>
        {
            ...
            protected override void ReadValue(DeepObject2 instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "StringValue":
                        ...
                        break;
                    case "RecursiveObject":
                        instance.RecursiveObject = Realms.Serialization.RealmObjectSerializer.LookupSerializer<Realms.Tests.Database.DeepObject3?>()!.DeserializeById(context);
                        break;
                    default:
