...
namespace Realms.Tests.Database
{
    ...
    public partial class ObjectEmbedded : IEmbeddedObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        [Realms.Preserve]
        static ObjectEmbedded()
        {
            Realms.Serialization.RealmObjectSerializer.Register(new ObjectEmbeddedSerializer());
            Realms.Sync.MongoClient.RegisterSchema(typeof(ObjectEmbedded), RealmSchema);
        }
        ...
        private IObjectEmbeddedAccessor Accessor => _accessor ??= new ObjectEmbeddedUnmanagedAccessor(typeof(ObjectEmbedded));
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="ObjectEmbedded"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(ObjectEmbedded? val) => (Realms.RealmValue)val;
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class ObjectEmbeddedManagedAccessor : Realms.ManagedAccessor, IObjectEmbeddedAccessor
        {
            public string? Value
            {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class ObjectEmbeddedUnmanagedAccessor : Realms.UnmanagedAccessor, IObjectEmbeddedAccessor
        {
        ...
        private class ObjectEmbeddedSerializer : Realms.Serialization.RealmObjectSerializerBase<ObjectEmbedded>
        {
            ...
            protected override ObjectEmbedded CreateInstance() => new ObjectEmbedded();

            protected override void ReadValue(ObjectEmbedded instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "Value":
            ...
            protected override void ReadArrayElement(ObjectEmbedded instance, string name, BsonDeserializationContext context)
            {
                // No persisted list/set properties to deserialize
            }

            protected override void ReadDocumentField(ObjectEmbedded instance, string name, string fieldName, BsonDeserializationContext context)
            {
