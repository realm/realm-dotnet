...
namespace Realms.Tests.Database
{
    ...
    public partial class Person : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        public static Realms.Schema.ObjectSchema RealmSchema = new Realms.Schema.ObjectSchema.Builder("Person", ObjectSchema.ObjectType.RealmObject)
        {
            ...
            Realms.Schema.Property.Primitive("LastName", Realms.RealmValueType.String, isPrimaryKey: false, indexMode: IndexMode.None, isNullable: true, managedName: "LastName"),
            Realms.Schema.Property.Primitive("Score", Realms.RealmValueType.Float, isPrimaryKey: false, indexMode: IndexMode.None, isNullable: false, managedName: "Score"),
            Realms.Schema.Property.Primitive("Latitude", Realms.RealmValueType.Double, isPrimaryKey: false, indexMode: IndexMode.None, isNullable: false, managedName: "Latitude"),
            Realms.Schema.Property.Primitive("Longitude", Realms.RealmValueType.Double, isPrimaryKey: false, indexMode: IndexMode.None, isNullable: false, managedName: "Longitude"),
            Realms.Schema.Property.Primitive("Salary", Realms.RealmValueType.Int, isPrimaryKey: false, indexMode: IndexMode.None, isNullable: false, managedName: "Salary"),
            Realms.Schema.Property.Primitive("IsAmbivalent", Realms.RealmValueType.Bool, isPrimaryKey: false, indexMode: IndexMode.None, isNullable: true, managedName: "IsAmbivalent"),
            ...
            Realms.Schema.Property.Primitive("PublicCertificateBytes", Realms.RealmValueType.Data, isPrimaryKey: false, indexMode: IndexMode.None, isNullable: true, managedName: "PublicCertificateBytes"),
            Realms.Schema.Property.Primitive("OptionalAddress", Realms.RealmValueType.String, isPrimaryKey: false, indexMode: IndexMode.None, isNullable: true, managedName: "OptionalAddress"),
            Realms.Schema.Property.Primitive("Email", Realms.RealmValueType.String, isPrimaryKey: false, indexMode: IndexMode.None, isNullable: true, managedName: "Email_"),
            Realms.Schema.Property.Primitive("IsInteresting", Realms.RealmValueType.Bool, isPrimaryKey: false, indexMode: IndexMode.None, isNullable: false, managedName: "IsInteresting"),
