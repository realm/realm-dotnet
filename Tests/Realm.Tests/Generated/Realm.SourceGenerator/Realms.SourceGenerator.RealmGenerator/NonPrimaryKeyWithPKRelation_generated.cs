...
namespace Realms.Tests.Database
{
    ...
    {
        [Generated]
        [Woven(typeof(NonPrimaryKeyWithPKRelationObjectHelper)), Realms.Preserve(AllMembers = true)]
        public partial class NonPrimaryKeyWithPKRelation : IRealmObject, INotifyPropertyChanged, IReflectableType
        {
            ...
            /// <summary>
            /// Defines the schema for the <see cref="NonPrimaryKeyWithPKRelation"/> class.
            /// </summary>
            ...
            private INonPrimaryKeyWithPKRelationAccessor Accessor => _accessor ??= new NonPrimaryKeyWithPKRelationUnmanagedAccessor(typeof(NonPrimaryKeyWithPKRelation));
            ...
            /// <summary>
            /// Converts a <see cref="Realms.RealmValue"/> to <see cref="NonPrimaryKeyWithPKRelation"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
            /// </summary>
            /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
            /// <returns>The <see cref="NonPrimaryKeyWithPKRelation"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
            public static explicit operator NonPrimaryKeyWithPKRelation?(Realms.RealmValue val) => val.Type == Realms.RealmValueType.Null ? null : val.AsRealmObject<NonPrimaryKeyWithPKRelation>();

            /// <summary>
            /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="NonPrimaryKeyWithPKRelation"/>.
            /// </summary>
            ...
            /// <summary>
            /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="NonPrimaryKeyWithPKRelation"/>.
            /// </summary>
            /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
            /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
            public static implicit operator Realms.QueryArgument(NonPrimaryKeyWithPKRelation? val) => (Realms.RealmValue)val;
            ...
            [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
            private class NonPrimaryKeyWithPKRelationManagedAccessor : Realms.ManagedAccessor, INonPrimaryKeyWithPKRelationAccessor
            {
            ...
            [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
            private class NonPrimaryKeyWithPKRelationUnmanagedAccessor : Realms.UnmanagedAccessor, INonPrimaryKeyWithPKRelationAccessor
            {
            ...
            [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
            private class NonPrimaryKeyWithPKRelationSerializer : Realms.Serialization.RealmObjectSerializer<NonPrimaryKeyWithPKRelation>
            {
                public override string SchemaName => "NonPrimaryKeyWithPKRelation";

                protected override void SerializeValue(MongoDB.Bson.Serialization.BsonSerializationContext context, BsonSerializationArgs args, NonPrimaryKeyWithPKRelation value)
                {
                ...
                protected override NonPrimaryKeyWithPKRelation CreateInstance() => new NonPrimaryKeyWithPKRelation();

                protected override void ReadValue(NonPrimaryKeyWithPKRelation instance, string name, BsonDeserializationContext context)
                {
                    switch (name)
                    {
                        case "StringValue":
                            ...
                            break;
                        case "OtherObject":
                            instance.OtherObject = LookupSerializer<Realms.Tests.Database.AddOrUpdateTests.PrimaryKeyObject?>()!.DeserializeById(context);
                            break;
                    }
                }

                protected override void ReadArrayElement(NonPrimaryKeyWithPKRelation instance, string name, BsonDeserializationContext context)
                {
                    // No persisted list/set properties to deserialize
                }

                protected override void ReadDocumentField(NonPrimaryKeyWithPKRelation instance, string name, string fieldName, BsonDeserializationContext context)
                {
