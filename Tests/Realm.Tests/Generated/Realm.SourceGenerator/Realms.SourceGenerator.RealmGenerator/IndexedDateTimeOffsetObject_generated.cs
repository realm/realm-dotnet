...
namespace Realms.Tests.Database
{
    ...
    public partial class IndexedDateTimeOffsetObject : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        /// <summary>
        /// Defines the schema for the <see cref="IndexedDateTimeOffsetObject"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Converts a <see cref="Realms.RealmValue"/> to <see cref="IndexedDateTimeOffsetObject"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
        /// </summary>
        /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
        /// <returns>The <see cref="IndexedDateTimeOffsetObject"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="IndexedDateTimeOffsetObject"/>.
        /// </summary>
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="IndexedDateTimeOffsetObject"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(IndexedDateTimeOffsetObject? val) => (Realms.RealmValue)val;
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class IndexedDateTimeOffsetObjectManagedAccessor : Realms.ManagedAccessor, IIndexedDateTimeOffsetObjectAccessor
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class IndexedDateTimeOffsetObjectUnmanagedAccessor : Realms.UnmanagedAccessor, IIndexedDateTimeOffsetObjectAccessor
        {
        ...
        private class IndexedDateTimeOffsetObjectSerializer : Realms.Serialization.RealmObjectSerializer<IndexedDateTimeOffsetObject>
        {
            protected override void SerializeValue(MongoDB.Bson.Serialization.BsonSerializationContext context, BsonSerializationArgs args, IndexedDateTimeOffsetObject value)
            {
                ...
                WriteValue(context, args, "DateTimeOffset", value.DateTimeOffset);

                context.Writer.WriteEndDocument();
            }

            protected override IndexedDateTimeOffsetObject CreateInstance() => new IndexedDateTimeOffsetObject();

            protected override void ReadValue(IndexedDateTimeOffsetObject instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "DateTimeOffset":
            ...
            protected override void ReadArrayElement(IndexedDateTimeOffsetObject instance, string name, BsonDeserializationContext context)
            {
                // No persisted list/set properties to deserialize
            }

            protected override void ReadDocumentField(IndexedDateTimeOffsetObject instance, string name, string fieldName, BsonDeserializationContext context)
            {
