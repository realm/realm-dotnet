...
namespace Realms.Tests
{
    ...
    public partial class PrivatePrimaryKeyObject : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        private IPrivatePrimaryKeyObjectAccessor Accessor => _accessor ??= new PrivatePrimaryKeyObjectUnmanagedAccessor(typeof(PrivatePrimaryKeyObject));
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="PrivatePrimaryKeyObject"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(PrivatePrimaryKeyObject? val) => (Realms.RealmValue)val;
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class PrivatePrimaryKeyObjectSerializer : Realms.Serialization.RealmObjectSerializer<PrivatePrimaryKeyObject>
        {
