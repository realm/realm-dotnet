...
namespace Realms.Tests.Database
{
    ...
    public partial class ExplicitClass : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        internal IExplicitClassAccessor Accessor => _accessor ??= new ExplicitClassUnmanagedAccessor(typeof(ExplicitClass));
        ...
        /// <summary>
        /// Converts a <see cref="Realms.RealmValue"/> to <see cref="ExplicitClass"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
        /// </summary>
        /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
        /// <returns>The <see cref="ExplicitClass"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
        public static explicit operator ExplicitClass?(Realms.RealmValue val) => val.Type == Realms.RealmValueType.Null ? null : val.AsRealmObject<ExplicitClass>();

        /// <summary>
        /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="ExplicitClass"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.RealmValue"/>.</param>
        /// <returns>A <see cref="Realms.RealmValue"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.RealmValue(ExplicitClass? val) => val == null ? Realms.RealmValue.Null : Realms.RealmValue.Object(val);

        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="ExplicitClass"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(ExplicitClass? val) => (Realms.RealmValue)val;
        ...
        private class ExplicitClassObjectHelper : Realms.Weaving.IRealmObjectHelper
        {
            ...
            public Realms.ManagedAccessor CreateAccessor() => new ExplicitClassManagedAccessor();

            public Realms.IRealmObjectBase CreateInstance() => new ExplicitClass();
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        internal interface IExplicitClassAccessor : Realms.IRealmAccessor
        {
            int Foo { get; set; }
        }
        ...
        private class ExplicitClassSerializer : Realms.Serialization.RealmObjectSerializer<ExplicitClass>
        {
            ...
            protected override void ReadDocumentField(ExplicitClass instance, string name, string fieldName, BsonDeserializationContext context)
            {
