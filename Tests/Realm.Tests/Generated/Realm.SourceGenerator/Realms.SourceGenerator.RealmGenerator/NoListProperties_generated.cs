...
{
    [Generated]
    [Woven(typeof(NoListPropertiesObjectHelper)), Realms.Preserve(AllMembers = true)]
    public partial class NoListProperties : IRealmObject, INotifyPropertyChanged, IReflectableType
    {

        [Realms.Preserve]
        static NoListProperties()
        {
            Realms.Serialization.RealmObjectSerializer.Register(new NoListPropertiesSerializer());
            Realms.Sync.MongoClient.RegisterSchema(typeof(NoListProperties), RealmSchema);
        }

        /// <summary>
        /// Defines the schema for the <see cref="NoListProperties"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Converts a <see cref="Realms.RealmValue"/> to <see cref="NoListProperties"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
        /// </summary>
        /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
        /// <returns>The <see cref="NoListProperties"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="NoListProperties"/>.
        /// </summary>
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="NoListProperties"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(NoListProperties? val) => (Realms.RealmValue)val;
        ...
        private class NoListPropertiesObjectHelper : Realms.Weaving.IRealmObjectHelper
        {
            ...
            public Realms.ManagedAccessor CreateAccessor() => new NoListPropertiesManagedAccessor();

            public Realms.IRealmObjectBase CreateInstance() => new NoListProperties();
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class NoListPropertiesManagedAccessor : Realms.ManagedAccessor, INoListPropertiesAccessor
        {
            public string? Name
            {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class NoListPropertiesUnmanagedAccessor : Realms.UnmanagedAccessor, INoListPropertiesAccessor
        {
        ...
        private class NoListPropertiesSerializer : Realms.Serialization.RealmObjectSerializerBase<NoListProperties>
        {
            ...
            protected override NoListProperties CreateInstance() => new NoListProperties();

            protected override void ReadValue(NoListProperties instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "Name":
            ...
            protected override void ReadArrayElement(NoListProperties instance, string name, BsonDeserializationContext context)
            {
                // No persisted list/set properties to deserialize
            }

            protected override void ReadDocumentField(NoListProperties instance, string name, string fieldName, BsonDeserializationContext context)
            {
