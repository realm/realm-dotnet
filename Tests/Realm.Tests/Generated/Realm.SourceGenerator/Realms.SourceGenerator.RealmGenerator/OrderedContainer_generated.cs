...
namespace Realms.Tests.Database
{
    ...
    public partial class OrderedContainer : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="OrderedContainer"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(OrderedContainer? val) => (Realms.RealmValue)val;
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class OrderedContainerManagedAccessor : Realms.ManagedAccessor, IOrderedContainerAccessor
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class OrderedContainerUnmanagedAccessor : Realms.UnmanagedAccessor, IOrderedContainerAccessor
        {
        ...
        private class OrderedContainerSerializer : Realms.Serialization.RealmObjectSerializer<OrderedContainer>
        {
            protected override void SerializeValue(MongoDB.Bson.Serialization.BsonSerializationContext context, BsonSerializationArgs args, OrderedContainer value)
            {
                ...
                WriteDictionary(context, args, "ItemsDictionary", value.ItemsDictionary);

                context.Writer.WriteEndDocument();
            }

            protected override OrderedContainer CreateInstance() => new OrderedContainer();
