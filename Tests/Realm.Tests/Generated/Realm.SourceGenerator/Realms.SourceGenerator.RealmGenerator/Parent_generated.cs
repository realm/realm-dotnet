...
namespace Realms.Tests.Database
{
    public partial class AddOrUpdateTests
    {
        ...
        public partial class Parent : IRealmObject, INotifyPropertyChanged, IReflectableType
        {
            ...
            private IParentAccessor Accessor => _accessor ??= new ParentUnmanagedAccessor(typeof(Parent));
            ...
            [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
            private class ParentSerializer : Realms.Serialization.RealmObjectSerializerBase<Parent>
            {
                public override string SchemaName => "Parent";
                ...
                protected override void ReadValue(Parent instance, string name, BsonDeserializationContext context)
                {
                    switch (name)
                    {
                        ...
                        case "Name":
                            ...
                            break;
                        case "Child":
                            instance.Child = Realms.Serialization.RealmObjectSerializer.LookupSerializer<Realms.Tests.Database.AddOrUpdateTests.Child?>()!.DeserializeById(context);
                            break;
                        default:
