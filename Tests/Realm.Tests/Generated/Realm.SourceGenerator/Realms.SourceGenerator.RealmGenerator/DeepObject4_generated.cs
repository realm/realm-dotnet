...
namespace Realms.Tests.Database
{
    ...
    public partial class DeepObject4 : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        /// <summary>
        /// Defines the schema for the <see cref="DeepObject4"/> class.
        /// </summary>
        [System.Reflection.Obfuscation]
        public static Realms.Schema.ObjectSchema RealmSchema = new Realms.Schema.ObjectSchema.Builder("DeepObject4", ObjectSchema.ObjectType.RealmObject)
        {
            ...
            Realms.Schema.Property.Object("RecursiveObject", "DeepObject5", managedName: "RecursiveObject"),
        }.Build();

        #region IRealmObject implementation

        private IDeepObject4Accessor? _accessor;

        Realms.IRealmAccessor Realms.IRealmObjectBase.Accessor => Accessor;

        private IDeepObject4Accessor Accessor => _accessor ??= new DeepObject4UnmanagedAccessor(typeof(DeepObject4));
        ...
        {
            var newAccessor = (IDeepObject4Accessor)managedAccessor;
        ...
        /// <summary>
        /// Converts a <see cref="Realms.RealmValue"/> to <see cref="DeepObject4"/>. Equivalent to <see cref="Realms.RealmValue.AsNullableRealmObject{T}"/>.
        /// </summary>
        /// <param name="val">The <see cref="Realms.RealmValue"/> to convert.</param>
        /// <returns>The <see cref="DeepObject4"/> stored in the <see cref="Realms.RealmValue"/>.</returns>
        public static explicit operator DeepObject4?(Realms.RealmValue val) => val.Type == Realms.RealmValueType.Null ? null : val.AsRealmObject<DeepObject4>();

        /// <summary>
        /// Implicitly constructs a <see cref="Realms.RealmValue"/> from <see cref="DeepObject4"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.RealmValue"/>.</param>
        /// <returns>A <see cref="Realms.RealmValue"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.RealmValue(DeepObject4? val) => val == null ? Realms.RealmValue.Null : Realms.RealmValue.Object(val);

        /// <summary>
        /// Implicitly constructs a <see cref="Realms.QueryArgument"/> from <see cref="DeepObject4"/>.
        /// </summary>
        /// <param name="val">The value to store in the <see cref="Realms.QueryArgument"/>.</param>
        /// <returns>A <see cref="Realms.QueryArgument"/> containing the supplied <paramref name="val"/>.</returns>
        public static implicit operator Realms.QueryArgument(DeepObject4? val) => (Realms.RealmValue)val;
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        internal interface IDeepObject4Accessor : Realms.IRealmAccessor
        {
            string? StringValue { get; set; }

            Realms.Tests.Database.DeepObject5? RecursiveObject { get; set; }
        }
        ...
        private class DeepObject4ManagedAccessor : Realms.ManagedAccessor, IDeepObject4Accessor
        {
            ...
            public Realms.Tests.Database.DeepObject5? RecursiveObject
            {
                get => (Realms.Tests.Database.DeepObject5?)GetValue("RecursiveObject");
        ...
        private class DeepObject4UnmanagedAccessor : Realms.UnmanagedAccessor, IDeepObject4Accessor
        {
            ...
            private Realms.Tests.Database.DeepObject5? _recursiveObject;
            public Realms.Tests.Database.DeepObject5? RecursiveObject
            {
            ...
            public DeepObject4UnmanagedAccessor(Type objectType) : base(objectType)
            {
            }
            ...
            public override void SetValue(string propertyName, Realms.RealmValue val)
            {
                switch (propertyName)
                {
                    ...
                    case "RecursiveObject":
                        RecursiveObject = (Realms.Tests.Database.DeepObject5?)val;
                        return;
                    default:
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class DeepObject4Serializer : Realms.Serialization.RealmObjectSerializerBase<DeepObject4>
        {
            ...
            protected override void ReadValue(DeepObject4 instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "StringValue":
                        ...
                        break;
                    case "RecursiveObject":
                        instance.RecursiveObject = Realms.Serialization.RealmObjectSerializer.LookupSerializer<Realms.Tests.Database.DeepObject5?>()!.DeserializeById(context);
                        break;
                    default:
