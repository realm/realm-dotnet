...
namespace Realms.Sync
{
    internal static class SharedRealmHandleExtensions
    {
        ...
        private static class NativeMethods
        {
            ...
            public static extern void realm_syncmanager_set_feature_token([MarshalAs(UnmanagedType.LPWStr)] string token, IntPtr token_len);
        }
        ...
        {
            NativeMethods.realm_syncmanager_set_feature_token(token, (IntPtr)token.Length);
        }
