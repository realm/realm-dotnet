...
{{
    newAccessor.Realm.Add(oldAccessor.{property.Name}, update);
                ...
                else
                {
                    ...
                    var indexMode = property.Index.ToCodeString();
                    var isNullable = property.IsRequired ? "false" : property.TypeInfo.IsNullable.ToCodeString();
                    schemaProperties.AppendLine(@$"Realms.Schema.Property.Primitive(""{property.GetMappedOrOriginalName()}"", {realmValueType}, isPrimaryKey: {isPrimaryKey}, indexMode: {indexMode}, isNullable: {isNullable}, managedName: ""{property.Name}""),");
