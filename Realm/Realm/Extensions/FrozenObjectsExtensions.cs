...
namespace Realms
{
    ...
    public static class FrozenObjectsExtensions
    {
        ...
        /// </summary>
        /// <param name="realmObj">The <see cref="IRealmObject"/> or <see cref="IEmbeddedObject"/> instance that you want to create a frozen version of.</param>
        /// <typeparam name="T">The type of the <see cref="IRealmObject"/>/<see cref="IEmbeddedObject"/>.</typeparam>
