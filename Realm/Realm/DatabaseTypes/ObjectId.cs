// <auto-generated>
// Vendored from the MongoDB .NET driver, Apache License 2.0:
// https://github.com/mongodb/mongo-csharp-driver/blob/5a9c3311e158910b88195f290e6d4b1b2715d2b2/src/MongoDB.Bson/ObjectModel/ObjectId.cs
//
// Adapted for Realm: moved to the Realms namespace, inlined the BsonUtils and BsonConstants
// helpers it used, and dropped the IConvertible conversions to BsonObjectId and BsonString.
// Those two conversions made the whole MongoDB.Bson serialization stack reachable from any app
// that also compiles a LINQ expression tree, which every Realm query does.
// </auto-generated>
...
namespace Realms
{
    ...
    public struct ObjectId : IComparable<ObjectId>, IEquatable<ObjectId>, IConvertible
    {
        ...
        // helpers inlined from MongoDB.Bson.BsonUtils and MongoDB.Bson.BsonConstants
        ...
        private static bool TryParseHexString(string s, out byte[] bytes)
        {
            ...
            while (i < s.Length)
            {
                if (!TryParseHexChar(s[i++], out var x) || !TryParseHexChar(s[i++], out var y))
                {
                    return false;
                }
