...
namespace Realms
{
    ...
    public readonly struct QueryArgument
    {
        ...
        internal readonly GeoBase? GeoValue;

        private QueryArgument(RealmValue? realmValue = null, GeoBase? geoValue = null)
        {
        ...
        /// <summary>
        /// Implicitly constructs a <see cref="QueryArgument"/> from <see cref="GeoBase" />.
        /// </summary>
        /// <param name="value">The value to store in the <see cref="QueryArgument"/>.</param>
        /// <returns>A <see cref="QueryArgument"/> containing the supplied <paramref name="value"/>.</returns>
        public static implicit operator QueryArgument(GeoBase? value) => new(geoValue: value);
        ...
        internal (NativeQueryArgument Value, RealmValue.HandlesToCleanup? Handles) ToNative()
        {
            ...
            return GeoValue switch
            {
                ...
                _ => throw new NotSupportedException($"Unsupported GeoBase type: {GeoValue?.GetType().FullName}")
            };
        }
    }
}
